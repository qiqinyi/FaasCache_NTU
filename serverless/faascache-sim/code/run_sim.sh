...
python3 ./split/many_run.py --tracedir ./data2/alfuerst/azure/functions/trace_pckl/precombined --numfuncs 392 --savedir ./data2/alfuerst/verify-test --logdir trace_output_dir/logs --memstep=3000


# analyze results  
python3 ./split/plotting/compute_mem_usage.py --logdir $log_dir --savedir $memory_dir

python3 ./split/plotting/compute_mem_usage.py --logdir ./data2/alfuerst/verify-test/logs --savedir ./data2/alfuerst/verify-test/memory
...
python3 ./split/plotting/plot_run_across_mem.py --analyzeddir ./data2/alfuerst/verify-test/analyzed --plotdir ./data2/alfuerst/plot --numfuncs 392
python3 ./split/plotting/plot_cold_across_mem.py --analyzeddir ./data2/alfuerst/verify-test/analyzed --plotdir ./data2/alfuerst/plot --numfuncs 392


python3 ./split/plotting/plot_many.py 


# --analyzeddir ./data2/alfuerst/verify-test/analyzed --plotdir ./data2/alfuerst/plot --numfuncs 392